...
const ProductDetail = () => {
  ...
  }, [fetchProduct, checkIfFavorited, user]);
  ...
  const handlePurchaseSuccess = () => {
    ...
    alert(
      "Gửi yêu cầu deal giá thành công! Người bán sẽ xem xét và phản hồi sớm.",
    );
  };
  ...
  const handleReportSuccess = () => {
    ...
    alert(
      "Báo cáo đã được gửi thành công! Chúng tôi sẽ xem xét và xử lý trong thời gian sớm nhất.",
    );
  };
    ...
    <div className="product-detail-container">
      ...
      <div className="product-detail-layout">
        ...
        <div className="product-right">
          ...
          <div className="price-card">
            ...
            {!isOwner && (
              <div className="action-buttons">
                <button className="btn btn-chat" onClick={handleStartChat}>
          ...
          {/* Report Button */}
          {!isOwner && (
            <button className="btn btn-report" onClick={handleReportProduct}>
